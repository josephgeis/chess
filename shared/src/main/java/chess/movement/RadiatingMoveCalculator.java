 ...
 */
public abstract class RadiatingMoveCalculator extends MoveCalculator {

    public RadiatingMoveCalculator(ChessPiece piece, ChessPosition startPosition, ChessBoard board) {
